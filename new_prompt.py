...
JSON_STRUCTURE = f"""
        ...
        Therefore, extraction must be meticulous, lossless, and fully capture the medical details. 
...
def get_prompt():
    prompt_v5 = f"""
                    ...
                    **Distinguishing Owner vs Multiple Clinics Information - CRITICAL**:
                    ...
                    - **NEVER use clinic information as owner information when owner data is not provided**
                    ...
                    **EXTRACTION LOGIC:**
                    ...
                    - `ids` key represents array of JSON, populated by 'id' and 'type' from clinic records
                    ...
                    **EXTRACTION LOGIC:**
                    ...
                    - Include service category, BCS (Body Condition Score), currency_code
                    ...
                    **TYPE:** Array of JSON.
                    **EXTRACTION LOGIC:**
                    - Extract `vaccine_name`, `date_administered`, `due_date`
                    - Include both historical vaccines and future scheduled doses
                    - Associate with `clinic_id`, `vet_id`, and `visit_id`
                    - Ensure no duplicates in vaccination details
                    ...
                    **EXTRACTION LOGIC:**
                    ...
                    - Include heartworm prevention, flea/tick control, dental care plans
                    ...
                    **TYPE:** JSON.
                    **EXTRACTION LOGIC:**
                    - Extract `document_type` (Visit Report, Invoice, Payment Receipt, Medical Record, Prescription)
                    ...
                    **EXTRACTION LOGIC:**
                    ...
                    ## Return the JSON in the following format, 
                       (By considering and interpreting all the extraction logics and nuances):
                    ...
                    **ALL** entries in these arrays MUST have visit_id populated:
                    ...
                    - **ALL** reminder entries require complete field population:
                    ...
                    - reminder_type: "Vaccination", "Check-up", "Medication", "Follow-up", "Preventive Care", "Monitoring", "Testing", "Dental", "Licensing", "Other"
                    ...
                    - currency_code populated for each visit based on clinic location or explicit mentions
                    ...
                    **Extraction succeeds ONLY if:**
                    ...
                    (NOTE: - You **must not miss any vaccinations, Test, or any critical medical report** mentioned in the above text, 
